...
try {
    // Get orders assigned to this delivery boy that are not delivered or cancelled
    $stmt = $pdo->prepare("
        SELECT o.*, 
        ...
        WHERE o.delivery_boy_id = ? AND o.status NOT IN ('delivered', 'cancelled')
    ...
    sendResponse(200, "Assigned orders fetched successfully", $orders);
